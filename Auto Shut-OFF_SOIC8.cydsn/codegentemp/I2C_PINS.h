...
#define I2C_REMOVE_SCL_PIN      (1u)
#define I2C_REMOVE_SDA_PIN      (1u)
...
#define I2C_SCL_PIN     (0u == I2C_REMOVE_SCL_PIN)
#define I2C_SDA_PIN     (0u == I2C_REMOVE_SDA_PIN)
...
#if (I2C_SCL_PIN)
    #include "I2C_i2c_scl.h"
#endif /* (I2C_SCL) */

#if (I2C_SDA_PIN)
    #include "I2C_i2c_sda.h"
#endif /* (I2C_SDA) */
...
#if (I2C_SCL_PIN)
    #define I2C_SCL_HSIOM_REG   (*(reg32 *) I2C_i2c_scl__0__HSIOM)
    #define I2C_SCL_HSIOM_PTR   ( (reg32 *) I2C_i2c_scl__0__HSIOM)
    #define I2C_SCL_HSIOM_MASK  (I2C_i2c_scl__0__HSIOM_MASK)
    #define I2C_SCL_HSIOM_POS   (I2C_i2c_scl__0__HSIOM_SHIFT)
#endif /* (I2C_SCL_PIN) */

#if (I2C_SDA_PIN)
    #define I2C_SDA_HSIOM_REG   (*(reg32 *) I2C_i2c_sda__0__HSIOM)
    #define I2C_SDA_HSIOM_PTR   ( (reg32 *) I2C_i2c_sda__0__HSIOM)
    #define I2C_SDA_HSIOM_MASK  (I2C_i2c_sda__0__HSIOM_MASK)
    #define I2C_SDA_HSIOM_POS   (I2C_i2c_sda__0__HSIOM_SHIFT)
#endif /* (I2C_SDA_PIN) */
...
#define I2C_SCL_PIN_INDEX       (0u)
#define I2C_SDA_PIN_INDEX       (1u)
...
#define I2C_SCL_PIN_MASK     ((uint32) 0x01u << I2C_SCL_PIN_INDEX)
#define I2C_SDA_PIN_MASK     ((uint32) 0x01u << I2C_SDA_PIN_INDEX)
...
#if (I2C_SDA_PIN)
    #define I2C_CHECK_SDA_PIN_USED \
                (I2C_PIN_DM_ALG_HIZ != \
                    I2C_GET_P4_PIN_DM(I2C_i2c_sda_PC, \
                                                   I2C_i2c_sda_SHIFT))
#endif /* (I2C_SDA_PIN) */
...
/* Unconfigured SCB: scl signal */
    ...
    #define I2C_WAIT_SCL_SET_HIGH  (0u == I2C_i2c_scl_Read())
...
#elif (I2C_SDA_PIN)
    #define I2C_WAIT_SDA_SET_HIGH  (0u == I2C_i2c_sda_Read())
#else
...
#define I2C_REMOVE_MOSI_SCL_RX_PIN         I2C_REMOVE_SCL_PIN
#define I2C_REMOVE_MISO_SDA_TX_PIN         I2C_REMOVE_SDA_PIN
...
#define I2C_MOSI_SCL_RX_PIN        I2C_SCL_PIN
#define I2C_MISO_SDA_TX_PIN        I2C_SDA_PIN
#ifndef I2C_SCLK_PIN
...
#define I2C_SS0_PIN                I2C_RTS_SS0_PIN
    ...
    #define I2C_MOSI_SCL_RX_HSIOM_REG      I2C_SCL_HSIOM_REG
    #define I2C_MOSI_SCL_RX_HSIOM_PTR      I2C_SCL_HSIOM_PTR
    #define I2C_MOSI_SCL_RX_HSIOM_MASK     I2C_SCL_HSIOM_MASK
    #define I2C_MOSI_SCL_RX_HSIOM_POS      I2C_SCL_HSIOM_POS
#endif /* (I2C_MOSI_SCL_RX_PIN) */

#if (I2C_MISO_SDA_TX_PIN)
    #define I2C_MISO_SDA_TX_HSIOM_REG      I2C_SDA_HSIOM_REG
    #define I2C_MISO_SDA_TX_HSIOM_PTR      I2C_SDA_HSIOM_REG
    #define I2C_MISO_SDA_TX_HSIOM_MASK     I2C_SDA_HSIOM_REG
    #define I2C_MISO_SDA_TX_HSIOM_POS      I2C_SDA_HSIOM_REG
...
#define I2C_MOSI_SCL_RX_PIN_INDEX      I2C_SCL_PIN_INDEX
#define I2C_MISO_SDA_TX_PIN_INDEX      I2C_SDA_PIN_INDEX
...
#define I2C_MOSI_SCL_RX_PIN_MASK      I2C_SCL_PIN_MASK
#define I2C_MISO_SDA_TX_PIN_MASK      I2C_SDA_PIN_MASK
