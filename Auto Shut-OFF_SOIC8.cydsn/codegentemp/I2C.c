...
static void I2C_ScbModeStop(void)
{
    ...
    *******************************************************************************/
    void I2C_SetPins(uint32 mode, uint32 subMode, uint32 uartEnableMask)
    {
        ...
        {
            hsiomSel[I2C_SCL_PIN_INDEX] = I2C_HSIOM_I2C_SEL;
            hsiomSel[I2C_SDA_PIN_INDEX] = I2C_HSIOM_I2C_SEL;

            pinsDm[I2C_SCL_PIN_INDEX] = I2C_PIN_DM_OD_LO;
            pinsDm[I2C_SDA_PIN_INDEX] = I2C_PIN_DM_OD_LO;
        }
    #if (!I2C_CY_SCBIP_V1)
        else if (I2C_SCB_MODE_SPI == mode)
        {
            hsiomSel[I2C_SCL_PIN_INDEX] = I2C_HSIOM_SPI_SEL;
            hsiomSel[I2C_SDA_PIN_INDEX] = I2C_HSIOM_SPI_SEL;
            hsiomSel[I2C_CTS_SCLK_PIN_INDEX] = I2C_HSIOM_SPI_SEL;

            if (I2C_SPI_SLAVE == subMode)
            {
                /* Slave */
                pinsDm[I2C_SCL_PIN_INDEX] = I2C_PIN_DM_DIG_HIZ;
                pinsDm[I2C_SDA_PIN_INDEX] = I2C_PIN_DM_STRONG;
                ...
                /* Disable input buffer */
                 pinsInBuf |= I2C_SDA_PIN_MASK;
            #endif /* (I2C_SDA_PIN) */
            }
            else /* (Master) */
            {
                pinsDm[I2C_SCL_PIN_INDEX] = I2C_PIN_DM_STRONG;
                pinsDm[I2C_SDA_PIN_INDEX] = I2C_PIN_DM_DIG_HIZ;
        ...
        else /* UART */
        {
            ...
            {
                /* SmartCard */
                hsiomSel[I2C_SDA_PIN_INDEX] = I2C_HSIOM_UART_SEL;
                pinsDm  [I2C_SDA_PIN_INDEX] = I2C_PIN_DM_OD_LO;
            }
            else /* Standard or IrDA */
            {
                ...
                {
                    hsiomSel[I2C_SCL_PIN_INDEX] = I2C_HSIOM_UART_SEL;
                    pinsDm  [I2C_SCL_PIN_INDEX] = I2C_PIN_DM_DIG_HIZ;
                }
    ...
    /* Note: the DR register settings do not effect the pin output if HSIOM is other than GPIO */
        ...
        I2C_SET_HSIOM_SEL(I2C_SCL_HSIOM_REG,
                                       I2C_SCL_HSIOM_MASK,
                                       I2C_SCL_HSIOM_POS,
                                        hsiomSel[I2C_SCL_PIN_INDEX]);

        I2C_i2c_scl_SetDriveMode((uint8) pinsDm[I2C_SCL_PIN_INDEX]);

    #if (!I2C_CY_SCBIP_V1)
        I2C_SET_INP_DIS(I2C_i2c_scl_INP_DIS,
                                     I2C_i2c_scl_MASK,
                                     (0u != (pinsInBuf & I2C_SCL_PIN_MASK)));
    #endif /* (!I2C_CY_SCBIP_V1) */
    #endif /* (I2C_SCL_PIN) */

    #if (I2C_SDA_PIN)
        I2C_SET_HSIOM_SEL(I2C_SDA_HSIOM_REG,
                                       I2C_SDA_HSIOM_MASK,
                                       I2C_SDA_HSIOM_POS,
                                        hsiomSel[I2C_SDA_PIN_INDEX]);

        I2C_i2c_sda_SetDriveMode((uint8) pinsDm[I2C_SDA_PIN_INDEX]);

    #if (!I2C_CY_SCBIP_V1)
        I2C_SET_INP_DIS(I2C_i2c_sda_INP_DIS,
                                     I2C_i2c_sda_MASK,
                                    (0u != (pinsInBuf & I2C_SDA_PIN_MASK)));
    #endif /* (!I2C_CY_SCBIP_V1) */
    #endif /* (I2C_SCL_PIN) */
