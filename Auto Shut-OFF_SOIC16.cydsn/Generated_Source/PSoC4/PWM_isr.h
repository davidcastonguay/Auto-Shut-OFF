...
#define PWM_isr_INTC_VECTOR            ((reg32 *) PWM_isr__INTC_VECT)

/* Address of the PWM_isr ISR priority. */
#define PWM_isr_INTC_PRIOR             ((reg32 *) PWM_isr__INTC_PRIOR_REG)
...
#define PWM_isr_INTC_SET_EN            ((reg32 *) PWM_isr__INTC_SET_EN_REG)

/* Address of the INTC.CLR_EN[x] register to bit clear the PWM_isr interrupt. */
#define PWM_isr_INTC_CLR_EN            ((reg32 *) PWM_isr__INTC_CLR_EN_REG)

/* Address of the INTC.SET_PD[x] register to set the PWM_isr interrupt state to pending. */
#define PWM_isr_INTC_SET_PD            ((reg32 *) PWM_isr__INTC_SET_PD_REG)

/* Address of the INTC.CLR_PD[x] register to clear the PWM_isr interrupt. */
#define PWM_isr_INTC_CLR_PD            ((reg32 *) PWM_isr__INTC_CLR_PD_REG)
